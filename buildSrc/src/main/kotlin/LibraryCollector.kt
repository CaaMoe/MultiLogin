...
//        val implementationConfiguration = target.configurations.get("implementation")
        target.afterEvaluate {
            target.tasks.register("summaryCalculate") {
//                dependsOn(implementationConfiguration)
//                doLast {
//                    val digestedMap: MutableMap<String, String> = HashMap()
//
//                    configurations[implementationConfiguration.name].resolvedConfiguration.resolvedArtifacts.forEach { artifact ->
