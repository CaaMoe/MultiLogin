...
import moe.caa.multilogin.bungee.MultiSignLoginResult;
...
public class BungeeListener implements Listener {
    ...
    public void onLogin(LoginEvent event){
        if (!event.getConnection().isOnlineMode() || !(((InitialHandler) event.getConnection()).getLoginProfile() instanceof MultiSignLoginResult)) {
