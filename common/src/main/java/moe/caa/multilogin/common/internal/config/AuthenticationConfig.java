...
public sealed abstract class AuthenticationConfig extends Configuration permits LocalAuthenticationConfig, RemoteAuthenticationConfig {
    ...
    public final ConfigurationValue<Boolean> alwaysEnableEncryptedConnection;
    ...
    public AuthenticationConfig(MainConfig mainConfig) {
        ...
        this.alwaysEnableEncryptedConnection = boolOpt(NodePath.path("always-enable-encrypted-connection"), mainConfig.defaultAlwaysEnableEncryptedConnection.get());
