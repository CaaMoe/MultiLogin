...
public class AdvancedSetting {
    ...
    private String database_skin_restorer_table_field_online_uuid = "online_uuid";
    private String database_skin_restorer_table_field_current_skin_url = "current_skin_url";
    private String database_skin_restorer_table_field_restorer_data = "restorer_data";
