...
public class MinecraftSessionServiceInvocationHandler implements InvocationHandler {
    private final FabricInjector injector;
    private final MinecraftSessionService origin;

    public MinecraftSessionServiceInvocationHandler(FabricInjector injector, MinecraftSessionService origin) {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if (authResult.isAllowed()) {
            ...
            injector.getServerLoginNetworkData().setDisconnectMessage(Thread.currentThread(), authResult.getKickMessage());
            return null;
        }
    }
    ...
    private String getIp(GameProfile profile, SocketAddress address) {
        ...
        SocketAddress socketAddress = injector.getServerLoginNetworkData().getSocketAddress(profile);
